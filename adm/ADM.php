		...
		if ($errorAdmCheq == 0 AND $sinHack){
			if ($data['Adatos']['que'] == 'admRubros'){
				...
				if ($errorAdmCheq == 0 AND $sinHack){
					...
					$esteInsert = "INSERT INTO `rubros` (`did`, `nombre`, `habilitado`, `quien`) VALUES ({$did}, '{$nombre}', {$habilitado}, {$quien})";
				}
				...
				if ($errorAdmCheq == 0 AND $sinHack){
					...
					$quien = $_SESSION['ScapaUsuarioDid']*1;
					$esteInsert = "INSERT INTO `familias` (`did`, `didRubro`, `nombre`, `habilitado`, `quien`) VALUES ({$did}, {$didPadre}, '{$nombre}', {$habilitado}, {$quien})";
				}
				...
				if ($errorAdmCheq == 0 AND $sinHack){
					...
					$quien = $_SESSION['ScapaUsuarioDid']*1;
					$esteInsert = "INSERT INTO `articulos` (`did`, `didFamilia`, `nombre`, `habilitado`, `quien`) VALUES ({$did}, {$didPadre}, '{$nombre}', {$habilitado}, {$quien})";
				}
				...
				if ($errorAdmCheq == 0 AND $sinHack){
					...
					$quien = $_SESSION['ScapaUsuarioDid']*1;
					$esteInsert = "INSERT INTO `mercados` (`did`, `nombre`, `habilitado`, `quien`) VALUES ({$did}, '{$nombre}', {$habilitado}, {$quien})";
				}
				...
				if ($errorAdmCheq == 0 AND $sinHack){
					...
					$quien = $_SESSION['ScapaUsuarioDid']*1;
					$esteInsert = "INSERT INTO `encuestas` (`did`, `nombre`, `desde`, `desdeText`, `hasta`, `hastaText`, `habilitado`, `quien`) VALUES ({$did}, '{$nombre}', '{$desde}', '{$desdeText}', '{$hasta}', '{$hastaText}', {$habilitado}, {$quien})";
				}
			}
		}
	} else {
