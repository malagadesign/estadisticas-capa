				...
				<div class="normal-table-list mg-t-30">
					<div class="basic-tb-hd">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="text-align: right;">
							<button type="button" class="btn btn-info waves-effect" data-toggle="modal" data-target="#myModalthree" id="botonCrearModificar" onclick="Fcrear();">Crear nuevo rubro</button>
						</div>
					</div>
						...
						<div class="row">
							...
							<div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
								<div class="nk-int-st">
									...
									<input type="text" autocomplete="new-password" name="nombre" id="nombre" placeholder="Nombre descriptivo del rubro" class="form-control input-sm" onkeyUp="FverificarCaracteres(this);" onChange="FverificarCaracteres(this);">
								</div>
							</div>
						</div>
					</div>
...
function FguardarForm(){
	...
	if (nombreSiNo == ''){
		sinerrores = false;
		notifyBox('top', 'right', '', 'danger', 'animated bounceIn', 'animated fadeOutUp', 'Nombre del rubro', 'No se puede crear un rubro sin nombre', '', 4000);
	}
	if (sinerrores) {
		let AdatosSiNo = {que: "admRubros", did: didSiNo, nombre: nombreSiNo, habilitado: habilitadoSiNo};
