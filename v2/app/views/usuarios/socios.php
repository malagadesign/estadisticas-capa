    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-user-tie me-2 text-capa-purpura"></i> Usuarios Socios</h1>
                    <p class="text-muted">Gestión de usuarios socios del sistema</p>
                </div>
...
<!-- Modal para Crear/Editar Usuario Socio -->
        ...
        <div class="modal-content">
            <div class="modal-header bg-capa-purpura text-white">
                <h5 class="modal-title">
                    ...
                    <span id="textoTitulo">Nuevo Socio</span>
                </h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="usuario" name="usuario" 
                               placeholder="ej: carrefour_lp, dia_tandil" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="mail" name="mail" 
                               placeholder="ej: contacto@mercado.com" required>
                    </div>
