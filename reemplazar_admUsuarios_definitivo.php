<?php
/**
 * Script definitivo para reemplazar usuarios/admUsuarios.php con versión correcta
 */

error_reporting(E_ALL);
ini_set('display_errors', 1);

echo "<h1>🔧 Reemplazo definitivo de usuarios/admUsuarios.php</h1>";
echo "<p>🔍 Reemplazando completamente el archivo con la versión correcta...</p>";

// ============================================
// PASO 1: CREAR ARCHIVO CORRECTO COMPLETO
// ============================================

echo "<h2>📁 PASO 1: Creando archivo correcto completo</h2>";

$archivo_path = 'usuarios/admUsuarios.php';

// Contenido correcto completo con mensaje 'Sin datos'
$contenido_correcto = '<?PHP
...
echo "<p>✅ Contenido correcto creado (" . strlen($contenido_correcto) . " caracteres)</p>";

// ============================================
// PASO 2: REEMPLAZAR ARCHIVO COMPLETAMENTE
// ============================================

echo "<h2>🔧 PASO 2: Reemplazando archivo completamente</h2>";

// Crear backup del archivo actual
$backup_path = 'usuarios/admUsuarios_backup_' . date('Y-m-d_H-i-s') . '.php';
if (file_exists($archivo_path)) {
    $contenido_actual = file_get_contents($archivo_path);
    file_put_contents($backup_path, $contenido_actual);
    echo "<p>✅ Backup creado: " . $backup_path . "</p>";
}

// Reemplazar archivo completamente
if (file_put_contents($archivo_path, $contenido_correcto)) {
    echo "<p>✅ Archivo usuarios/admUsuarios.php reemplazado exitosamente</p>";
} else {
    echo "<p>❌ Error al reemplazar archivo</p>";
}
...
echo "<p style='color: green; font-weight: bold;'>🎉 ¡REEMPLAZO DEFINITIVO COMPLETADO!</p>";
echo "<p>💡 <strong>Próximo paso:</strong> Ve a usuarios/admUsuarios.php para ver el listado</p>";

echo "<hr>";
echo "<p><strong>📝 Nota:</strong> Este script reemplaza completamente el archivo usuarios/admUsuarios.php con la versión correcta que incluye el mensaje 'Sin datos'.</p>";
?>
