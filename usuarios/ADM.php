...
function mandarMailUsuario($did, $usuario, $hash, $mailDelUsuario, $superar, $tipo){
	...
	$tabla_contenido = "
		...
		<br><br>
		<a href='https://estadistica-capa.org.ar/encuestas/log/?h={$hash}'>Link</a>: (https://estadistica-capa.org.ar/encuestas/log/?h={$hash})
		<br><br>
		...
		";//Estimado {$usuario} ({$did}), su acceso a CAPA es: <a href='https://estadistica-capa.org.ar/encuestas/log/?h={$hash}'>Click aquí</a>";
